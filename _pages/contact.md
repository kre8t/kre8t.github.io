...
<p>Children's books email: <img src="{{"/assets/img/ihorton-email.svg" | relative_url}}" width="218" height="16" alt="i.horton email" class="uk-inline uk-margin-left" uk-svg></p>
